...
public:
    ...
    // call function f every d milliseconds
    int setInterval(long d, timer_callback f, void *userData);

    // call function f once after d milliseconds
    int setTimeout(long d, timer_callback f, void *userData);

    // call function f every d milliseconds for n times
    int setTimer(long d, timer_callback f, int n, void *userData);
...
private:
    ...
    // pointers to userData for timers
    void *userData[MAX_TIMERS];
